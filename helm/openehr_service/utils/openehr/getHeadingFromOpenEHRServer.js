...
var getHeadingByJumper = require('../jumper/lib/getHeadingFromOpenEHRServer');
...
function getHeading(nhsNo, heading, host, session, openEHRSession, callback) {
  ...
  if (getHeadingByJumper && openehr_config.headings[heading] && openehr_config.headings[heading].template && openehr_config.headings[heading].template.name) {
