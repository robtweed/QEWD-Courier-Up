...
var postHeadingByJumper = require('../jumper/lib/postHeading');
...
function postHeading(patientId, heading, data, qewdSession, callback) {
  ...
  if (!defaultHost) {
    defaultHost = openehr_config.defaultPostHost || 'ethercis';
  }

  if (postHeadingByJumper && openehr_config.headings[heading] && openehr_config.headings[heading].template && openehr_config.headings[heading].template.name) {
